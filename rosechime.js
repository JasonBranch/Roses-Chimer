...
// calling rose movement side to side
 ...
 petals[i].ymotion();
   petals[i].dir();
    ...
    if ( piezo1<.2 && piezo1>0 && counter1 == 0){
...
//else if (mappedValue>=25 && mappedValue<50 && counter2 ==0){
  else if (piezo2<.2 && piezo2>0 && counter2 ==0){
  //calling to push new set of roses
...
//  chime4.stop();
  ...
  else if (piezo2>.2 && counter2 == 0){
  
  petals.push(new Petals());
 angleMode(DEGREES);  //ellipse(width/4, height/2, piezo1 +100, piezo1 +100);
  ...
  else if (piezo3<.2 && piezo3>0 && counter3 ==0){
  //calling to push new set of roses
  roses.push(new Roses());
 angleMode(DEGREES);
 // chime1.stop();
...
//  chime4.stop();
 ...
 angleMode(DEGREES);  //ellipse(width/4, height/2, piezo1 +100, piezo1 +100);
  ...
  else if (piezo4<.2 && piezo4>0 && counter4 ==0){
  //calling to push new set of roses
  roses.push(new Roses());
 angleMode(DEGREES);
 // chime1.stop();
...
//  chime4.stop();
 ...
 angleMode(DEGREES);  //ellipse(width/4, height/2, piezo1 +100, piezo1 +100);
  ...
  else if (piezo5<.2 && piezo5>0 && counter5 ==0){
  //calling to push new set of roses
  roses.push(new Roses());
 angleMode(DEGREES);
 // chime1.stop();
